...
//		final int ERROR_INDEX = Arrays.asList(TOKENS).indexOf("ERROR");
		...
		for(Token t: tokens.getTokens()) {
			typeid = t.getType();
				...
				System.out.println("Invalid Token generated AT LiNE: " + t.getLine() + " for text \""+t.getText()+"\"");
				continue;
			}
			if(typeid != EOF_TYPEID) {
				...
				if(typeid == 3 || typeid == 7 || typeid == 43)
					output += " \"" + t.getText() + "\"";
